...
The issue about this approach is that we can only do export pages as a static website **manually**. If I published a page and then found there are some notes need correction, he needs to go over the tedious steps again. 🤦
