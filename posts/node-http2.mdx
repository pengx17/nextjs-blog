...
但经过简单调查发现，Express 对于 HTTP2 的支持并不是非常好，同时 [Express 项目的维护状态](https://www.reddit.com/r/node/comments/l67u0t/what_is_the_current_status_of_express_js_project/) 也令人担忧。
